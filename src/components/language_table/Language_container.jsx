        ...
        <>
            <div className="language_container">
                {languages.map((language) => (
                    <div className="button_container" key={language.id}>
                        <button className={`${activeLanguage && activeLanguage.id === language.id ? "active" : ""} button`} onClick={() => setActiveLanguage(language)}>
                            {language.title}
                        </button>
                    </div>
                ))}
            </div>
            <LanguageAndInfo activeLanguage={activeLanguage}></LanguageAndInfo>
        </>
    );
}